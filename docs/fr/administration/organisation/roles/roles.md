...
Pour le modèle de permissions dans son ensemble (rôles intégrés, accès restreint aux modèles), voir le concept [Organisation, rôles et permissions](../../../concepts/organisation-et-permissions.md).
